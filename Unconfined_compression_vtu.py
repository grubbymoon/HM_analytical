...
x_pos = np.array([0,0.1,0.1,2.2204E-17,0.05,0.1,0.05,1.1102E-17,0.2,0.2,0.15,0.2,0.15,0.3,0.3,0.25,0.3,0.25,0.4,0.4,0.35,0.4,0.35,0.5,0.5,0.45,0.5,0.45,0.6,0.6,0.55,0.6,0.55,0.7,0.7,0.65,0.7,0.65,0.8,0.8,0.75,0.8,0.75,0.9,0.9,0.85,0.9,0.85,1,1,0.95,1,0.95,0.1,4.4409E-17,0.1,0.05,3.3307E-17,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,6.6613E-17,0.1,0.05,5.5511E-17,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,8.8818E-17,0.1,0.05,7.7716E-17,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,1.1102E-16,0.1,0.05,9.992E-17,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,1.3323E-16,0.1,0.05,1.2212E-16,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,1.5543E-16,0.1,0.05,1.4433E-16,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,1.7764E-16,0.1,0.05,1.6653E-16,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,1.9984E-16,0.1,0.05,1.8874E-16,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95,0.1,2.2204E-16,0.1,0.05,2.1094E-16,0.2,0.2,0.15,0.3,0.3,0.25,0.4,0.4,0.35,0.5,0.5,0.45,0.6,0.6,0.55,0.7,0.7,0.65,0.8,0.8,0.75,0.9,0.9,0.85,1,1,0.95])
...
def plot_temp_ana(name):
    ...
    u1 = np.zeros(len(x_pos))
    for i in range(len(x_pos)):
        u1[i] = r0 * (-epsilon0) * lambda_s / (HA + lambda_s) * x_pos[i] / r0

    u2 = np.zeros(len(x_pos))
    for i in range(len(x_pos)):
    ...
    lns1 = ax.plot(data.arc_length, data.displacement0, "o", mec="red", mfc="none", label='ogs6')
